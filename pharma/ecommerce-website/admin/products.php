...
if (isset($_POST['add_product'])) {
   ...
   if ($select_products->rowCount() > 0) {
      ...
      $insert_products = $conn->prepare("INSERT INTO `products` (name, details, price, image, stock) VALUES (?, ?, ?, ?, ?)");
      $insert_products->execute([$name, $details, $price, $image, $stock]);
      ...
      <form action="" method="post" enctype="multipart/form-data">
         <div class="flex">
            ...
            <div class="inputBox">
               ...
               <input type="number" min="0" class="box" required max="9999999999" placeholder="Enter product stock"
